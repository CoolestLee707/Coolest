...
@implementation WBTimeProfiler

+ (WBTimeProfiler *)sharedTimeProfiler
{
    static dispatch_once_t onceToken;
    static WBTimeProfiler *profiler = nil;
    dispatch_once(&onceToken, ^{
        profiler = [[WBTimeProfiler alloc] initTimeProfilerWithMainKey:@""];
    });
    return profiler;
}
...
- (void)saveTimeProfileDataIntoFile:(NSString *)fileName
{
    ...
    MagicLog(@"TMTimeProfiler::SaveFilePath is %@", filePath);
